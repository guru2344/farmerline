...
// SECRET
// =====================
const SECRET_KEY = process.env.JWT_SECRET || "farmerline_secret";
...
app.post("/api/service", async (req, res) => {
  ...
  try {
    await pool.query(
      "INSERT INTO service_requests (name, address, service, email, contact) VALUES ($1,$2,$3,$4,$5)",
      [name, address, service, email, contact]
    );
...
// =====================
app.get("/api/service", verifyToken, async (req, res) => {
  try {
